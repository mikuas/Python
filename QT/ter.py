...
class SystemControl:
    ...
    def disableTaskManage(self, num):
        os.system(
            f'reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System" /v DisableTaskMgr /t REG_DWORD /d {num} /f')
        return self
    ...
    def copy(self, file_path, save_path):
...
def main():
    ...
    # 创建主窗口并播放视频
    main_win = MainWindow(SystemControl.getFilePath('video.mp4'))
