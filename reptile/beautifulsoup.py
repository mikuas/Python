...
# print(body.h1.string)

# for item in body.children:
#     print(item, type(item))

# print(body.contents, type(body.contents))

""" 后代标签 """
tagsDes = body.descendants
# print(tagsDes, type(tagsDes))
# print(list(tagsDes))

""" 兄弟标签 """
span = body.span
# print(span.next_sibling.next_sibling.next_sibling)
# print(span.previous_sibling.previous_sibling)
# print(list(span.previous_siblings))

""" 父标签 """
# print(span.parent)
# print(list(span.parents))


a = soup.find_all('span', attrs={'class': 'type'})
# print(a)
