...
class SubWindow:
    def __init__(self, keyboardWindow, imageWindow, regeditWindow, calcWindow):
        ...
        self.keyboardWindowButton.setStyleSheet("font-size: 24px")
        ...
        self.imageWindowButton.setStyleSheet("font-size: 24px")
        ...
        self.regeditWindowButton.setStyleSheet("font-size: 24px")
        ...
        self.calcWindowButton.setStyleSheet("font-size: 24px")
