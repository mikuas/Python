...
from PySide6.QtCore import QPropertyAnimation, QPoint, Qt, QEasingCurve, QSize, QRect, QParallelAnimationGroup
...
class Window(VerticalScrollWidget):
    ...
    def createColorAni(self):
        ...
        posAni1.finished.connect(print('ani1 end'))
        posAni2.finished.connect(print('ani2 end'))

        animationGroup.start()
        animationGroup.finished.connect(print("Animation finished"))
